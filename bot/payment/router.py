...
#             inline_keyboard=[
#                 [
#                     InlineKeyboardButton(text="25,000 токенов (1 ⭐️)",
#                                          callback_data=f"buy_stars 25,000 1 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="50,000 токенов (2 ⭐️)",
#                                          callback_data=f"buy_stars 50,000 2 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="100,000 токенов (4 ⭐️)",
#                                          callback_data=f"buy_stars 100,000 180 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="1,000,000 токенов (40 ⭐️)",
#                                          callback_data=f"buy_stars 1,000,000 40 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="⬅️ Назад к выбору модели", callback_data="back_buy_model"),
#                 ],
...
#             inline_keyboard=[
#                 [
#                     InlineKeyboardButton(text="10,000 токенов (1 ⭐️)",
#                                          callback_data=f"buy_stars 25,000 1 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="30,000 токенов (3 ⭐️)",
#                                          callback_data=f"buy_stars 40,000 3 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="100,000 токенов (10 ⭐️)",
#                                          callback_data=f"buy_stars 100,000 10 {model}"),
#                 ],
#                 [
#                     InlineKeyboardButton(text="1,000,000 токенов (400 ⭐️)",
...
# @paymentsRouter.callback_query(StartWithQuery("buy_stars"))
# async def handle_buy_balance_model_query(callback_query: CallbackQuery):
#     amount = callback_query.data.split(" ")[2]
#     tokens = callback_query.data.split(" ")[1]
#     model = callback_query.data.split(" ")[3]
#     builder = InlineKeyboardBuilder()  
#     prices = [LabeledPrice(label="XTR", amount=amount)]  
